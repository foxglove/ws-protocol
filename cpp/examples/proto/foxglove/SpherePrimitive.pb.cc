...
namespace foxglove {
PROTOBUF_CONSTEXPR SpherePrimitive::SpherePrimitive(
...
struct SpherePrimitiveDefaultTypeInternal {
  PROTOBUF_CONSTEXPR SpherePrimitiveDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SpherePrimitiveDefaultTypeInternal _SpherePrimitive_default_instance_;
}  // namespace foxglove
static ::_pb::Metadata file_level_metadata_foxglove_2fSpherePrimitive_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_foxglove_2fSpherePrimitive_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_foxglove_2fSpherePrimitive_2eproto = nullptr;

const uint32_t TableStruct_foxglove_2fSpherePrimitive_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::foxglove::SpherePrimitive)},
};
...
static ::_pbi::once_flag descriptor_table_foxglove_2fSpherePrimitive_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_foxglove_2fSpherePrimitive_2eproto = {
    false, false, 231, descriptor_table_protodef_foxglove_2fSpherePrimitive_2eproto,
    "foxglove/SpherePrimitive.proto",
    &descriptor_table_foxglove_2fSpherePrimitive_2eproto_once, descriptor_table_foxglove_2fSpherePrimitive_2eproto_deps, 3, 1,
    schemas, file_default_instances, TableStruct_foxglove_2fSpherePrimitive_2eproto::offsets,
    file_level_metadata_foxglove_2fSpherePrimitive_2eproto, file_level_enum_descriptors_foxglove_2fSpherePrimitive_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_foxglove_2fSpherePrimitive_2eproto(&descriptor_table_foxglove_2fSpherePrimitive_2eproto);
namespace foxglove {
...
const ::foxglove::Pose&
SpherePrimitive::_Internal::pose(const SpherePrimitive* msg) {
  return *msg->_impl_.pose_;
}
const ::foxglove::Vector3&
SpherePrimitive::_Internal::size(const SpherePrimitive* msg) {
  return *msg->_impl_.size_;
}
const ::foxglove::Color&
SpherePrimitive::_Internal::color(const SpherePrimitive* msg) {
...
SpherePrimitive::SpherePrimitive(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:foxglove.SpherePrimitive)
}
SpherePrimitive::SpherePrimitive(const SpherePrimitive& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SpherePrimitive* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.pose_){nullptr}
    , decltype(_impl_.size_){nullptr}
    , decltype(_impl_.color_){nullptr}
...
inline void SpherePrimitive::SharedCtor(
...
void SpherePrimitive::SetCachedSize(int size) const {
...
const char* SpherePrimitive::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData SpherePrimitive::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    SpherePrimitive::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*SpherePrimitive::GetClassData() const { return &_class_data_; }


void SpherePrimitive::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
bool SpherePrimitive::IsInitialized() const {
  return true;
}

void SpherePrimitive::InternalSwap(SpherePrimitive* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata SpherePrimitive::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::foxglove::SpherePrimitive*
Arena::CreateMaybeMessage< ::foxglove::SpherePrimitive >(Arena* arena) {
  return Arena::CreateMessageInternal< ::foxglove::SpherePrimitive >(arena);
}
